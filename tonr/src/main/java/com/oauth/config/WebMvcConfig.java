...
import com.oauth.tonr.SparklrService;
import com.oauth.tonr.converter.AccessTokenRequestConverter;
import com.oauth.tonr.impl.SparklrServiceImpl;
import com.oauth.tonr.mvc.CodeRedirectController;
import com.oauth.tonr.mvc.FacebookController;
import com.oauth.tonr.mvc.SparklrController;
import com.oauth.tonr.mvc.SparklrRedirectController;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	@Bean
	public CodeRedirectController codeRedirectController(@Value("${accessTokenUri}") String accessTokenUri,
	@Value("${authCodeTonrRedirect}") String authCodeTonrRedirect){
		CodeRedirectController codeRedirectController = new CodeRedirectController();
		codeRedirectController.setAccessTokenUri(accessTokenUri);
		codeRedirectController.setAuthCodeTonrRedirect(authCodeTonrRedirect);
		return codeRedirectController;
	}
