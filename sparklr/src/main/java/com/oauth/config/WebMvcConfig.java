...
import com.oauth.PhotoInfo;
import com.oauth.PhotoService;
import com.oauth.impl.PhotoServiceImpl;
import com.oauth.mvc.AccessConfirmationController;
import com.oauth.mvc.AdminController;
import com.oauth.mvc.PhotoController;
import com.oauth.mvc.PhotoServiceUserController;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	private PhotoInfo createPhoto(String id, String userId) {
		...
		photo.setResourceURL("/com/oauth/impl/resources/" + photo.getName());
		return photo;
	}
